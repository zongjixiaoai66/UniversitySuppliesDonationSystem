...
public class QiuzhuLiuyanView extends QiuzhuLiuyanEntity implements Serializable {
	...
	public QiuzhuLiuyanView() {

	}

	public QiuzhuLiuyanView(QiuzhuLiuyanEntity qiuzhuLiuyanEntity) {
		try {
			BeanUtils.copyProperties(this, qiuzhuLiuyanEntity);
