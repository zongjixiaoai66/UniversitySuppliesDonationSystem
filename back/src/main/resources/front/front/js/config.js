...
var centerMenu = [
    ...
    ,{
        name: '捐赠信息',
        url: '../juanzheng/list.html'
    }
    ,{
        name: '求助信息',
        url: '../qiuzhu/list2.html'
    }
    ,{
        name: '求助收藏',
        url: '../qiuzhuCollection/list.html'
    }
    ,{
        name: '求助留言',
        url: '../qiuzhuLiuyan/list.html'
    }
...
var indexNav = [
    ...
    {
        name: '求助信息',
        url: './pages/qiuzhu/list.html'
    },

]

// 已废弃,不用了
var adminurl =  "http://localhost:8080/gaoxiaowupinjuanzeng/admin/dist/index.html#/login";
