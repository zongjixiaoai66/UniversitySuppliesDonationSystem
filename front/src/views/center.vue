  ...
  <div>
    ...
    >  
     <el-row>
         ...
         <el-col :span="12">
           <el-form-item v-if="flag=='yonghu'"  label='积分数量' prop="yonghuJif">
               <el-input v-model="ruleForm.yonghuJif"  placeholder='积分数量' clearable></el-input>
           </el-form-item>
         </el-col>
...
// 注册表 用户 的级联表
  ...
  methods: {
    ...
    onUpdateHandler() {
                         ...
                         if((!this.ruleForm.yonghuJif)&& 'yonghu'==this.flag){
