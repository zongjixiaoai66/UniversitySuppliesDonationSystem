    ...
    <div class="addEdit-block">
        <el-form
            ...
            <el-row>
               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="积分数量" prop="yonghuJif">
                       <el-input v-model="ruleForm.yonghuJif"
                                 placeholder="积分数量" clearable  :readonly="ro.yonghuJif"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
                       <el-form-item class="input" label="积分数量" prop="yonghuJif">
                           <el-input v-model="ruleForm.yonghuJif"
