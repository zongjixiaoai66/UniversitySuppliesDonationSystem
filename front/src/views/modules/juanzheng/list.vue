                ...
                <el-row class="ad" :style="{justifyContent:contents.btnAdAllBoxPosition=='1'?'flex-start':contents.btnAdAllBoxPosition=='2'?'center':'flex-end'}">
                    <el-form-item>
                        ...
                        <a style="text-decoration:none" class="el-button el-button--success"
                           ...
                           href="http://localhost:8080/gaoxiaowupinjuanzeng/upload/juanzhengMuBan.xls"
                        >批量导入捐赠信息数据模板</a>
                        &nbsp;
                        <el-upload
                                v-if="isAuth('juanzheng','导入导出')"
            ...
            <div class="table-content">
                <el-table class="tables" :size="contents.tableSize" :show-header="contents.tableShowHeader"
                    ...
                    <el-table-column  :sortable="contents.tableSortable" :align="contents.tableAlign"
                                      ...
                                      label="备注">
                        <template slot-scope="scope">
                            <span v-if="scope.row.juanzhengText != null &&scope.row.juanzhengText.length>10">
                                {{scope.row.juanzhengText.slice(0,10)}}...
                            </span>
                            <span v-else>
                                {{scope.row.juanzhengText}}
                            </span>
                        </template>
                    </el-table-column>
        ...
        methods: {
            chartDialog() {
                ...
                let params = {
                    ...
                    thisTable : {//当前表
                        tableName :'juanzheng',//当前表表名,
                        sumColum : 'juanzheng_number', //求和字段
                        date : 'insert_time',//分组日期字段
                        // string : 'juanzheng_name',//分组字符串字段
                        // types : 'juanzheng_types',//分组下拉框字段
                    },
                    // joinTable : {//级联表（可以不存在）
