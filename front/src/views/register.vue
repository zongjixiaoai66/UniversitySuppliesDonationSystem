    ...
    <div>
        <div class="container">
            <div class="login-form">
                <h1 class="h1" style="color:#000;fontSize:28px;">高校物品捐赠管理系统注册</h1>
                <el-form class="rgs-form">
                    ...
                    <el-form-item label="重复密码" class="input">
                        ...
                        <!--
                            <el-form-item label="积分数量" class="input" v-if="tableName=='yonghu'">
                                <el-input v-model="ruleForm.yonghuJif" autocomplete="off" placeholder="积分数量"  />
                           </el-form-item>
                        -->
                        <!--
    ...
    export default {
        ...
        methods: {
            ...
            login() {
                            ...
                            // yonghu 中的 积分数量 判空处理
                            // if('yonghu' == this.tableName && (this.ruleForm.yonghuJif== null ||this.ruleForm.yonghuJif== "")){
...
<style lang="scss" scoped>
    ...
    .container {
        ...
        background-image: url(/gaoxiaowupinjuanzeng/img/back-img-bg.jpg);
